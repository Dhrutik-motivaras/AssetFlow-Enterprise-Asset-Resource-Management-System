...
SECRET_KEY = 'django-insecure-+69e+ewkp-^l@i30@qg#tmhr$+it#oy$tncnk2jru8(tktw3#w'
...
# Database configuration: prefer PostgreSQL via env/config, but fall back to SQLite for local development
